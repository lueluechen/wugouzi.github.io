...
** 6.2 Pivoting Strategies
   ...
   *Paritial Pivoting*: Determine the smallest $p\ge k$ s.t.
...
* TODO COMMENT hw [11%]
  ...
  - [ ] NA03-CH2-A
    ...
    Error analysis: compare the rate

    Atiken's method
    - [ ]
  - [X] NA03-CH6-AB
    - [X] Gauss-Jordan method
    - [X] amount of computation of elimination
  - [ ] NA04-CH6-A
  ...
  - [ ] NA07-CH3-AB
    ...
    Linear interpolation step size estimate
  - [ ] NA08-CH3-A
...
* TODO COMMENT points [0%]
  - [ ] eigen decomposition
  - [ ] eigenvalue calculation
  - [ ] 奇异值分解
  - [ ] 矩阵求逆
    
* TODO COMMENT Research topic
  - [ ] extend newton's method
  - [ ] secant method
    
    advantage and disadvantage
  - [ ] conditional
  - [ ] dolittle. compact form
  - [ ] Hilbert matrix

    use four-digit rounding arithmetic to compute the inverse $H^{-1}$ of the
    $3\times 3$ Hilbert matrix $H$ and then compute $\hat{H}=(H^{-1})^{-1}$.
    Determine $\norm{H-\hat{H}}_\infty_$
  - [ ] wielandt deflation for finding the second most dominant eigenvalue and
    associated eigenvector of a matrix
* COMMENT Haven't write
  - NA03-ch2-a: steffensen's method
  - choleski
  - norm convergence
  - iterative refinement
  - newton backward
